...
- 毕竟黑名单最大的问题，就是可能会三天两头 补充规则，不胜其烦。
- 
- 黑名单模式，同时也会增加7000个规则（与一直力求规则越少越好，背道而驰）
...
我还是那个观点！⚠️⚠️⚠️ 规则数量 不是越多越好！！ NB，体现在做减法。在非核心目标上，不断做加法，摊大饼、大而全， 没有意义。本套模版的最核心目标是 “省电”  。其次是（针对上层网关）隐秘行踪。而不是 ，一次性，堆十几万、二十几万规则，导致每此域名请求都要比对十多万规则。这样只会让手机续航➗2。没有任何意义。
