...
有3种 修改方案：
 ...
 |  方案 2  |   修改模版 | 将“回国分流” ，从第二级（序号：2st），搬移到 第四级（序号：4st） 和 第五级（序号：5st）之间  |  在 “费电vs容错” 之间取平衡 | 
| 方案 3  | 修改模版  | 将 “回国分流” ，从第二级（序号：2st），搬移到 兜底规则之前 | 分流🇨🇳 中国分流规则的容错度 最高，效果 = 随便错 都不怕 🔥🔥🔥 但 最费电 ❕ |
...
总结：方案3，对中国规则集合的容错度更高。可以说，几乎是随便错😂 都不怕。

因为对于方案3来说，相当于，当所有的境外流量全部分走之后，在白名单兜底分流发挥作用前，最后试一把有没有中国IP、中国域名在内。如果匹配上就直连。
