...
⚠️⚠️⚠️⚠️ 不看完 如下 两章 ，上来就想 指挥人当保姆的、或说本模版有BUG的。🤣 直接 0 社交 关闭issue
...
如果 你实在不想读完，可以找AI （ 如 ChatGPT Pro/Think ）给你总结大纲，然后挑着读。

如果你连总结都不想读，压根一行说明 都不想读。那你把 《 你的需求 + 本项目 + 节点配置 》扔给 Codex 5.5 xhigh ，让他帮你全自动 裁切 适配，然后发你无脑用。 记住，“花钱”（token） =  你（从codex）直接拿结果 = 最佳实践❗️❗️❗️

如果你比上述更懒，建议找机场主，让他做适配导入工作，然后发你 = 你无脑用。🤣🤣 说白了，收钱 ，丫能 纯躺 不干活 ？？？ 收钱必须提供服务


PS：千万别用，免费、免费、免费ai❕❕ 更别用 豆包 、千问、元宝 ！
...
本模版会通过以下的 节点专属的代理组 ，来收集 您手动填写 或 自动订阅的节点 。 即，其他代理组（尤其是与分流规则一一对应的代理组），都不会直接引用节点，都是通过引用如下代理组来获取节点的。

> 本模版中， “中转“ 节点，不仅仅可用于中转，也可直接访问网站。称之为  ⚠️ ”优质线路“节点 ⚠️ ，会更贴切。但为了 ”简洁“ 表述，此处起名为 ”中转“节点 ，但并不意味着，其功能只限于 中转 ❕❕❕
...
如何启用上述代理组，建议直接问 “付费AI” ，一定是付费AI，免费的100%会出错 （ ⚠️ 注意：不要在这里发Issue 问怎么改。你这 = 纯让别人做保姆，200% 会被我秒拉黑❕ 反馈BUG、反馈优化写法 ，除外 ） 。 或者让你购买的机场客服，来帮你修改好。
...
四套模版 ，分别对应四大场景：
  ...
  >  - 💻 Desktop   === 白名单 + 只兼容 Clash Meta + 桌面端优化

  >  - 🏴 Blacklist === 黑名单 + 只兼容 Clash Meta 
...
| [BlackList-03-Non.AntiAD.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/BlackList-03-Non.AntiAD.yaml)                                                                    |     [订阅](https://cdn.jsdelivr.net/gh/Accademia/Clash_Configuration_Template/BlackList-03-Non.AntiAD.yaml)      |    黑名单  |            |    2.4     |  🛑    |  ❌   |      ❌       |   🔞    |      0.7      |    🚫      |    
...
###  🟩🟩🟩🟩  第一阶段 ：选择模版，并在VPN软件中，导入 本模版的 订阅链接  🟩🟩🟩🟩 

本模版开箱即用 你可以通过 如下 订阅链接，将本模版直接 下载+导入 到你的 Clash Meta / Stash 软件中。

> 注意： “不不不不是” 导入下面所有链接 ！！！导入你用到的即可。 建议的导入链接，已经通过 🔥🔥🔥 标注出来了


### 【第一套】 兼容 Stash / Clash Meta   + 白名单模式 

   - #### 订阅链接   :   [\[通用模版\]-WhiteList-01.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/%5B%E9%80%9A%E7%94%A8%E6%A8%A1%E7%89%88%5D-WhiteList-01.yaml) 
   ...
   - #### 订阅链接   :   [\[通用模版\]-WhiteList-03-Non.AntiAD.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/%5B%E9%80%9A%E7%94%A8%E6%A8%A1%E7%89%88%5D-WhiteList-03-Non.AntiAD.yaml)    
   ...
   - 仅限 Stash 客户端 用户，选第一套模版。其他客户端用户，强烈不建议选 第一套模版（ 主要是 比其他模版 配置繁琐 ），请从第2-4套中选择。

<br>  

### 【第二套】 仅兼容 Clash Meta + 白名单模版  +  手机 移动端优化

- #### 订阅链接   :   [[Mobile]-WhiteList-01.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/[Mobile]-WhiteList-01.yaml)                                                   
...
- #### 订阅链接   :   [[Desktop]-WhiteList-01.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/[Desktop]-WhiteList-01.yaml)                                                                 
          
   >    https://cdn.jsdelivr.net/gh/Accademia/Clash_Configuration_Template/[Desktop]-WhiteList-01.yaml


- #### 订阅链接   :   [[Desktop]-WhiteList-02-Min.AntiAD.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/[Desktop]-WhiteList-02-Min.AntiAD.yaml)                                           
          
   >    https://cdn.jsdelivr.net/gh/Accademia/Clash_Configuration_Template/[Desktop]-WhiteList-02-Min.AntiAD.yaml


- #### 订阅链接   :  [[Desktop]-WhiteList-03-Non.AntiAD.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/[Desktop]-WhiteList-03-Non.AntiAD.yaml)  🔥    （ 备选，电脑 ）                                    
...
- #### 订阅链接   :   [BlackList-01.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/BlackList-01.yaml)                                                                                       
                      
   >  https://cdn.jsdelivr.net/gh/Accademia/Clash_Configuration_Template/BlackList-01.yaml           


- #### 订阅链接   :   [BlackList-02-Min.AntiAD.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/BlackList-02-Min.AntiAD.yaml)                                                               
                           
   > https://cdn.jsdelivr.net/gh/Accademia/Clash_Configuration_Template/BlackList-02-Min.AntiAD.yaml     


- #### 订阅链接   :   [BlackList-03-Non.AntiAD.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/BlackList-03-Non.AntiAD.yaml)                                                               
           
   > https://cdn.jsdelivr.net/gh/Accademia/Clash_Configuration_Template/BlackList-03-Non.AntiAD.yaml       
...
### 为什么填入订阅信息后，代理组 没有识别出来（或没有识别全）订阅的节点？
  ...
  ##### Clash模版 ：需要定制过滤器，来适配你机场的节点命名风味！
   ...
   >
   > - 如果机场主 只收钱不干活 = 纯纯的吃相难看。你也不要在这里发issue，我 ❌拒绝回答❌ 一般性问题，会直接关闭issue（而且还会 “拉黑” 这种 = 0营养交流 + 不做任何功课 TM 纯粹让人当 “免费保姆” 的巨婴❕❕❕ ）。建议你直接找付费AI去问（如 ChatGPT Think、Pro）。 注意一定是 💰 “付费AI” ，所有 “免费AI” 都是垃圾，一定会改错。
   > 
  ...
  ##### ⚠️⚠️⚠️⚠️⚠️ 本模版中的 “内置过滤器” ，其适配的 “命名规则”  ⚠️⚠️⚠️⚠️⚠️
   ...
   > 强烈建议：你可以让机场主，按照如下命名规则，修改他门机场节点的名称 = 秒适配本模版 🚗🚗🚗🚗
   ...
   >    - HomeIP ： 带有住宅IP的线路 
   >      
   >    - Relay ：可以做为中转的  优质线路（如：9929 、CN2）
   >      
   >    - ShowIP ： 可以用作 “修改IP归属地显示” 的 优质线路（如：9929 、CN2）

   >
   
   >  ▶ ▶ ▶  协议+端口  ◀ ◀ ◀
   >      
   >    - RT ： Vless + Reality + Vision + XUDP
   >      
   >    - H2 ： Hysteria2
   >      
   >    - 00 ： xxx端口  
   ...
   >       - 代理链  =
   >           - 【出口】落地节点 ： 美国线路、住宅级IP 、 Reality 协议 、 第3个端口   
   >           - 【入口】中转节点 ： 日本中转线路 
   >           - 【多级代理链】 ： 从右向左 =  从入口到出口 如 ： 出口 <<- 中转 3 <- 中转 2  <- 中转 1 ｜ 入口
   >
   >  - 【 范例 2 】: VPS-[US-Relay]-H2-01
   >       - 节点 = 美国线路 、中转级IP 、 使用 Hysteria2 协议 、 第1个端口
   >
   >  - 【 范例 3 】: VPS-[US.HomeIP]-H2-1133 
   >       - 节点 = 美国线路 、住宅级IP  使用 Hysteria2 协议 、 1133端口
   >  

   
   注意： 本模版会假定，“修改IP归属地显示” 的节点，无需中转 本身就是 “最优质” 的线路。
    
   >   - 从体验角度来说，要想在修改IP归属地的同时，体验 = 国内直连，必须用最快的线路（尽管对应的国内APP，其图片、 视频、内容等CDN，已经从国内加载了，不会产生绕路。但是某些 “应答延迟” “验证延迟” ，总是被木桶最短的板所阻碍）
   >
   >   - 并且，也考虑到 Stash对UDP代理链无法适配，导致只能放弃代理链（非核心原因，体验差才是核心原因）。


   注意： 本模版会假定，所有 住宅IP的线路 都是非优质线路，都需要中转。
    
   >   - 现实也是如此，真实的 🇺🇸美国的极品级住宅IP，都是100%车库级机房，都是在真实住宅 + 真实的美国运营商（如AT&T）宽带组成的，价格都在几百人民币每月。这种线路，别说国际出口差，连本地出口都很差（被服务商切割了，一个千兆宽带买10份-30份）
   > 
   >   - 真实的 住宅IP、手机IP 的云主机 ，是2023年才开始普及的业务 ，市场竞争 到2025年 非常不充分。看着吧，未来5年内，必然会充分竞争到 山姆店价格。什么一个千兆带宽卖10-30份还几百块一个月的，几年内就会成为历史。
   >
   >   - 欧美很多住宅IP才能访问的网站，对 像诺顿这种欧美大牌杀毒公司、上市公司的 VPN，很多也是友好的。（ 诺顿VPN 无法从 🇨🇳中国 和 🇷🇺俄罗斯 等其他流氓国家 直连出去，会被墙 ）

   如果你自认为你的 住宅IP节点 是顶级线路，无需通过代理链就可高速访问，可以点击这个链接，来修改 ：
   >   -  [《 如何魔改本模版 ： 如何将 住宅IP线路 ，从 “代理链优先”，改为 “直连优先” ？ 》](https://github.com/Accademia/Clash_Configuration_Template?tab=readme-ov-file#%E5%A6%82%E4%BD%95%E9%AD%94%E6%94%B9%E6%9C%AC%E6%A8%A1%E7%89%88--%E5%A6%82%E4%BD%95%E5%B0%86-%E4%BD%8F%E5%AE%85ip%E7%BA%BF%E8%B7%AF-%E4%BB%8E-%E4%BB%A3%E7%90%86%E9%93%BE%E4%BC%98%E5%85%88%E6%94%B9%E4%B8%BA-%E7%9B%B4%E8%BF%9E%E4%BC%98%E5%85%88-) 
...
如果您，只有 “订阅节点” ，没有 “自建节点” ，那配置到这一步就结束了

   > 在结束之前 ！ ⚠️ 请注意 ：如果您配置的设备是  路由器 、（手机电脑间歇性的会作为）热点 ，建议将订阅节点内的所有节点域名和节点IP都加入直连白名单 （ 如何配置，请看这里 ：  [【 第四阶段 】 避免 链上套链](https://github.com/Accademia/Clash_Configuration_Template?tab=readme-ov-file#--%E7%AC%AC%E5%9B%9B%E9%98%B6%E6%AE%B5--%E9%81%BF%E5%85%8D-%E9%93%BE%E4%B8%8A%E5%8A%A0%E9%93%BE-%E5%A8%83%E4%B8%8A%E5%A5%97%E5%A8%83-%E9%80%89%E4%BD%9C--) ） 。如果你非上述两种用途，那配置就已经结束了。

<br>

对于有 “自建节点” 的，请继续完成 剩余的 配置环节，请看 “ 第三阶段 ：如何导入 自建节点 ”
...
<br> 
  ...
  - ### 🟩 第一步： 只验证一个节点
    ...
    ```yaml 
     ...
     #### --------------------------------------------------------------------
     #### 台湾（TW）  - 中转节点  - 默认不启用  ， 不建购买此地区的VPS 自建中转节点  （ 🤮🤮 线路普遍又贵又差 ）                                                     
     #### --------------------------------------------------------------------
     ...
     #### --------------------------------------------------------------------
     #### 新加坡（SG） - 中转节点  - 默认不启用  ， 不建购买此地区的VPS 自建中转节点 （ 🤮🤮 线路普遍又贵又差 ）                                                        
     #### --------------------------------------------------------------------
    ...
    ```
          ⚠️⚠️⚠️ 要特别注意 ❗️❗️❗️❗️❗️ 本项目所有 注释符号 ，使用 “空格键” 进行删除 ！！千万不要 为了图省事，使用 “退格键” 删除注释符号！！！不然模版无法工作！删除注释前后，必须 必须 必须 保证 行内剩余字符的列位置不变！必须保证删除注释符号前后，列对齐不变。除非注释符号在行首一个字符（注释符号前没有任何空格、字符），那种才可以使用 退格键进行删除。❗️❗️❗️❗️❗️  不注意以上两点的本脚本你修改的时候，100%报错。如果还听不明白的。扔给Codex 付费版，让他给你解释。
...
<br>
  ...
  - ### 🟩 第三步，根据自己的节点位置 整理命名
    ...
    > 注意 ：如果您配置的设备是  路由器 、（手机电脑间歇性的会作为）热点 ，建议将订阅节点内的所有节点域名和节点IP都加入直连白名单 （ 如何配置，请看这里 ：  [【 第四阶段 】 避免 链上套链](https://github.com/Accademia/Clash_Configuration_Template?tab=readme-ov-file#--%E7%AC%AC%E5%9B%9B%E9%98%B6%E6%AE%B5--%E9%81%BF%E5%85%8D-%E9%93%BE%E4%B8%8A%E5%8A%A0%E9%93%BE-%E5%A8%83%E4%B8%8A%E5%A5%97%E5%A8%83-%E9%80%89%E4%BD%9C--) ） 。如果你非上述两种用途，
    ...
    > 如果你下载的是 [通用模版] ，请继续 痛苦的完成后面四个的步骤。

    <br> 
    
  - ### 🟩 第四步 ，配置 《通用模版》 
      
      - 对于《通用模版》，需要在已完成第三步的基础上，进一步配置。请
      
      -  如果你的《通用模版》 ，是在 Clash Meta 内核 中运行的，请继续配置： 在源代码中查找：
          
          > ClashMeta_Only 包裹着的代码 ，启用 ✅
          
          > Stash_Compatible 包裹住的代码，关闭 ❌

          ⚠️⚠️⚠️ 要特别注意 ❗️❗️❗️❗️❗️ 本项目所有 注释符号 ，使用 “空格键” 进行删除 ！！
    ...
    <br> 
      ...
      -  【此阶段是为了启用Stash中的链式代理，理论上，此阶段在最新版的Stash中已经无需配置了，即可支持了】如果你的《通用模版》 ，是在 Stash 客户端 中运行的，请继续配置： 在源代码中查找：
...
### 🟩🟩🟩🟩  第四阶段 ： 避免 链上加链 娃上套娃 （选作）  🟩🟩🟩🟩

<br> 

> 注意：此阶段，仅针对  路由器 、（手机电脑间歇性的会作为）热点 ，才建议配置。如果你非上述两种用途，可以 “跳过” 本阶段的所有步骤。
...
在如上两处代码中，填写你所有的代理节点的域名和IP，以便于在 “路由器” 、“手机热点” 上部署时，能够子网内 开启了本地 VPN APP 的设备，能够直连这些节点，从而 100% 避免 “娃上套娃” 、 “链上加链” 的情况（不但 延迟 x2 、流量消耗也 x2 ）。配置好后，记得删除掉注释字符，代码才能工作。
...
因为🇨🇳国产IOT设备，都是不可信的。即，只要你家局域网中的 IOT 设备， （通过反诈插件）跑几个简单的 预设黑名单，就能标记出，你在OpenClash路由器上配置的分流规则中的所有VPN节点IP，然后如果它上报给GFW，那你家所有VPN节点IP都会被阻断。🤣🤣 你马立刻100%傻眼，如果在同步给辖区派出所上门查扣设备，您就喜提3000元罚款吧。而且技术上非常简单，比如，通过如下网页，轻易就能知道到节点，然后秒上报给GFW：
...
#  如何魔改本模版 ： 如何将 住宅IP线路 ，从 “代理链优先”，改为 “直连优先” ？
...
> - [BlackList-01.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/BlackList-01.yaml)           

> - [BlackList-02-Min.AntiAD.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/BlackList-02-Min.AntiAD.yaml)        

> - [BlackList-03-Non.AntiAD.yaml](https://github.com/Accademia/Clash_Configuration_Template/blob/main/BlackList-03-Non.AntiAD.yaml)       
...
# 为什么 本模版配置好后，在家里（或直连5G、4G）能正常上网  ，但是联入  ”🇨🇳国内高校” 网络后，就连不上国内网络了？但翻墙后的国外网络反而能连 ？ 

<br>

大概率是因为，你们学校把 国内外，所有的DOH、DOT、DNS都阻断了。所以，导致你通过本模版走境外VPS的DNS解析，能正常拿到结果，但是通过本模版走国内阿里腾讯DOH，反而被阻断，从而导致国内无法上网。

解决方法 就是将 模版本凡事使用 https://dns.alidns.com/dns-query#**** 和  https://doh.pub/dns-query#**** 的，全部都替换成 system （ 使用线路默认的DNS ）

这是非常典型的“中国特色”的层层加码。实际上GFW并没有要求🇨🇳中国高校阻断任何DNS、DOH，而是中国高校的领导层，为了最大限度保住自己的帽子，使用的一种手段。控制校外DNS访问，只是随时防治学生通过网络发生群体性事件的一种预防手段。即，让所有的网络出口都是可控的，随时监听，随时限流、随时断网。反正爷铁饭碗 + 您证在爷手里 / 您的聘书在爷手里 = 在座的各位 都是爷的垃圾 🤣 

法国作家 维克多雨果 说过 ：“每多建一所学校，就少建一座监狱。” 而在🇨🇳中国做到了，“每多建一所大学，都是一座新的监狱” ———— 引用自2005年水木清华BBS被迫关闭校外访问的祭文

只能说，各位没生到好时候，2005年以前的高校互联网，压根不是这样的。尤其是在90年代互联网，更不是这样的。
...
# ‼️‼️ 为什么 很多机场，还是会推荐，使用 “ Fake IP + Fallback DNS ” 翻墙 ？ 他们是不是更专业？

先说结论： 不是因为他们更专业。而是因为他们 = 不在乎你死活 + 人家只想赚钱 。

Fake IP 唯一的好处就是 ，打开页面的延迟能感觉更低一些，在给客户使用的时候，可以最大化提升自己线路，在非晚高峰时段的牛逼性。从而促成你下单。

说白了，人家用了，能让东西的卖相更好。懂吗？至于，这里面是不是有科技与狠活儿？吃了会不会有毒？人家会在乎？中国人的小聪明尽显无疑 🤣 各个都是西贝贾国龙+小米雷军附体。人家只想5分钱馒头卖22块 或者 人家只想小字自称 xxx只项目名称 不是指 产品性能，你买了后，你自己用出了问题，您自己烧死在车里，关人家什么鸟事儿？🤣

说白了，大多数 小白 用 Fallback DNS 后，有几个人能搞得清楚 ，哪些规则的写法 ，会产生DNS泄漏，哪些不会 ？？？？？ 其后果就是，您必然会产生DNS泄漏，从而100%会被GFW识别出特征，只是GFW会不会人肉找你罢了。而奸商？钱赚到手了。还需要在乎你死活？

你要记住，你的目的是“安全上外网” 。机场商贩，其目的是 “最大化赚钱”。你俩目标，是不一样的 !!! 你信丫 一0品牌 赚快钱 的，还不如信我是秦始皇 🤣
