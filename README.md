...
PS：不建议将 中国分流，放在境外分流之后，，是因为会大大增加命中前的匹配次数，每次命中都要比对几万条、十几万条，才能发现是日常用的，必须直连的 国内IP。0价值费电！
...
# 小而精准的 GeositeCN + geoip:cn 并不能满足 我的场景需求，怎么办？
...
对于方案2来说，相当于，当所有的境外流量全部分走之后，在白名单兜底分流发挥作用前，最后试一把有没有中国IP、中国域名在内。如果匹配上就直连。
