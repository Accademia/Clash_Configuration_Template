...
<br>
 ...
 -  本模版使用 ，**DNS白名单解析 + IP白名单分流**  =  几乎99.99% 🇨🇳 国内直连 
     ...
     -  DNS：白名单解析
         -  为了让 🇨🇳 中国网站，只会解析到🇨🇳国内IP。通过 “DNS分流策略” 内置 白名单机制（geosite:cn）。让国内网站的域名，直连国内DNS，从而解析到国内IP地址。
         
     -  IP：白名单分流
         -  为了让🇨🇳国内IP地址，直连中国大陆。通过在 “分流规则” 中使用geoip:cn， 对上述DNS解析后的IP进行分流。使得 访问🇨🇳国内网站 ，不会绕路到国外。
