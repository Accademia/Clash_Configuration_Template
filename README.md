...
而且不仅仅是反诈插件，病毒对VPN节点也是巨大危险。比如中毒设备，通过路由器配置的VPN节点疯狂发垃圾邮件。你VPN节点立马报销🤣 。尤其是像智能电视这种可安装第三方APP的设备，非常容易被病毒程序攻击 远程安装病毒APP。其易被感染程度，就像你用你手机上的“电视助手APP”，给你家电视装APP一样容易。其实，很多人家里的智能电视，都已经被入侵，只是你没察觉。这些被入侵的电视机，会在必要时会成为DDOS源，在平时，你家电视也可能会间歇性的发送垃圾邮件（只是消耗流量极低，你在路由器流量监控中根本看不出来有问题）。这些都是99.999%的人观察不到的。像我有个朋友家的索尼9系（顶配）电视机，国际大牌，依然会中毒，而且反复重置都不管用（隔一段时间又会被感染）。如果你不是专业级的，完全察觉不出来中毒，因为病毒几个小时、几十分钟才会不定期才发送一批的垃圾邮件。这些病毒，在发送垃圾邮件的过程中，如果匹配到了你部署在OpenClash路由器上的的规则，如果使用了你的VPN节点发垃圾邮件，会导致你的节点瞬间被封禁。即便你是 “订阅节点” 量大，可以甩锅给机场主 ，不怕被封，那你也可能会遭遇，因为频繁切中转线路，而导致体验极差。
