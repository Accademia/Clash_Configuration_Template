...
| 02-WhiteList-Min.AntiAD_模版.yaml | 1.9 万条  | 1.25 万条 | 0.65 万条 | 
...
## 如何魔改本模版，从而做到 进一步省电？
   ...
   - 本套规则中， 为什么没有使用 Geosite ：CN ？
       + 因为  Geosite ：CN 里面包含几百条错误的规则，这些规则背后指向了境外IP，却被标识成中国域名，包括但不限于TikTok。强烈不建议使用 Geosite ：CN 。规则数量，不是越多越好 ！！！！优先一定是省电（尤其在iPhone、MacBook电脑），其次是准确度高，再次是隐私性，最后才是更全面。
...
2. 尽量不要选择 ：海外华人、中国人 开设的VPS。坑非常多，例举几点：
    ...
    - 国产厂商，相当多 吃相难看 + 套路满满。
        - 比如，有些国产厂商，会针对测速软件进行优化。妥妥的中国人的小聪明尽显无疑。比如 像 saltyfish （ https://portal.saltyfish.io/ ）这样的华人厂商 ，会在你测速的时候拉满带宽，但是当你下载大文件时间超过1分钟以后，瞬间把你带宽降低非常低。使用脚本进行测速的时候根本看不出来。关键也不会在购买页面说明，先骗你上车，然后换脸。
    - 国产厂商，没有契约精神。
