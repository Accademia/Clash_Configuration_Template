...
注意：以下所有模版，都是，通过对《通用模版》进行进一步 裁剪、阉割，从而得到的  = 0添加 新代码。
...
<br>
  ...
  #### 注意：以下模版，在上述 “适配桌面端” 模版 基础上，又又再次裁剪、阉割（ 0添加 新代码 ）。进一步 额外阉割了 “实时切换黑名单模式” 功能 ， 和 其他冗余规则 （用以优化功耗）
