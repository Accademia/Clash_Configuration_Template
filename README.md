...
### [Desktop] \ [Mobile] ：专属 Clash Meta模版 （ 删除了 “Stash兼容” ）  
...
[通用模版] vs [Desktop] \ [Mobile] ，两者的区别， 只是为了适配的 不同的客户端 ！\[通用模版\] 额外支持 Stash客户端。所以，你下载 [通用模版] 后，你需要更多步骤 的 手工配置才能用起来（可配置性更全面）。所以，其代码容量更大。
