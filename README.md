...
手动激活方法：
   - 第一步：在模版中寻找 “ ClashMeta_Only ” 包裹的住的代码，取消其注释（激活源代码）
   - 第二步：在模版中寻找 “ Stash_Compatible “ 包裹的住的代码，注释掉（或删除掉）源代码
   - 上述两步完成后，此功能便激活。

💥💥💥💥 强烈建议，纯Clash meta用户，激活此功能 💥💥💥💥。 从而彻底解决 海外节点 ”跨国绕路“ 的问题。

而Stash for iOS用户，需要等Stash客户端在DNS分流策略中支持 “Rule-Set” 和 “代理集合” 这两个功能后，才能支持。 本人已经向 Stash开发组 提交过多次反馈，开发组压根 0反馈 、0回复。🤣🤣🤣 100% 纯血版 已读不回 ❕
