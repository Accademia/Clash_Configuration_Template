...
而且目前。国产路由器、国产光猫已经内置反诈插件了。下一步，你家的IOT设备，尤其是华为设备，通过OTA升级部署反诈插件，只是时间问题。像联通赠送的家庭摄像头、国产智能电视机、扫地机器人、智能中继、甚至你家智能冰箱。这些设备都是太好的载体。尤其像智能电视这种，其风险更大。这种可安装第三方APP的设备，非常容易被病毒程序攻击 远程安装病毒APP。就像你用电视助手给你家电视装APP一样。其实，很多人家里的智能电视，都已经被入侵，在必要时会成为DDOS源，在平时，你家电视也可能会间歇性的发送垃圾邮件（只是消耗流量极低，你在路由器流量监控中根本看不出来有问题）。这些都是99.999%的人观察不到的。包括我朋友家的索尼9系（顶配）电视机，依旧会中毒，而且反复重置都不管用（隔一段时间又会被感染）。如果你不是专业级的，根本察觉不出来，因为病毒几个小时、几十分钟才会不定期才发送一批的垃圾邮件。这些病毒，在发送垃圾邮件的过程中，如果匹配到了你部署在OpenClash路由器上的的规则，如果使用了你的VPN节点发垃圾邮件，会导致你的节点瞬间被封禁。即便你是 “订阅节点” 量大有甩锅给机场主 不怕被封，那你也可能会遭遇，频繁切中转线路，导致体验极差。所以，无路从哪个角度来看，都强烈 不不不不不不不建议，把所有节点和规则，都配置到  “家庭总出口” 的路由器上。
