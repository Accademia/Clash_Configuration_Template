...
<br>
 ...
 - 本模版，强制 落地节点 匹配 最近的CDN。以避免出现 “全球绕路” ！！即，可100%避免，如 “ 美国落地节点 去 访问日本CDN” 的情况 ❕ 
     - 此功能为Clash Meta独占功能，但Stash for iOS由于不支持Clash Meta的DNS分流特性，所以导致不支持此功能。
     - 为了保证本模版在iOS、Android、Win、Mac之间的通用性，所以，此功能默认关闭
     - 手动激活方法：
         - 第一步：在模版中寻找 “ ClashMeta_Only ” 包裹的住的代码，取消其注释
         - 第二步：在模版中寻找 “ Stash_Compatible “ 包裹的住的代码，注释掉（或删除掉）
         - 上述两步完成后，此功能便激活。
