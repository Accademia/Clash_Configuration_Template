...
当然，用户也可以将自己的本地的Geosite:CN规则集合，分享给社区，从而社区完善 规则集合汇总，可以集腋成裘。极大减轻社区制作规则的压力。并且不仅仅对中国的VPN社区极有价值。 对 俄罗斯、朝鲜、伊朗 等其他流氓国家的用户（尤其是 几乎0社区的用户群），一样非常有价值。
