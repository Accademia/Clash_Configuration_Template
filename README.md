...
###  在模版中， 需修改的 “VPN节点配置”
   ...
   ### ----------------------------------------------------------------
    ...
    - &RT_US_HomeIP_00 { name : 'RT-00—[US.HomeIP]—(美国住宅节点信息)' 
    - &RT_US_HomeIP_01 { name : 'RT-01—[US.HomeIP]—(美国住宅节点信息)' 
   ...
   ### ----------------------------------------------------------------
    ...
    - &RT_US_ShowIP_00 { name : 'RT-00—[US.ShowIP]—(归属地落地节点信息)
    - &RT_US_ShowIP_01 { name : 'RT-01—[US.ShowIP]—(归属地落地节点信息)
   ...
   ### ----------------------------------------------------------------
    ...
    - &RT_US_Relay_00 { name : 'RT-00—[US-Relay]—(美国中转节点信息)'   
    - &RT_US_Relay_01 { name : 'RT-01—[US-Relay]—(美国中转节点信息)'   
   ...
   ### ----------------------------------------------------------------
    ...
    - &RT_JP_Relay_00 { name : 'RT-00—[JP-Relay]—(日本中转节点信息)'   
    - &RT_JP_Relay_01 { name : 'RT-01—[JP-Relay]—(日本中转节点信息)'   
   ...
   ### ----------------------------------------------------------------
    ...
    - &RT_UK_Relay_00 { name : 'RT-00—[UK-Relay]—(英国中转节点信息)'   
    - &RT_UK_Relay_01 { name : 'RT-01—[UK-Relay]—(英国中转节点信息)'   
   ...
   ### ----------------------------------------------------------------
    ...
    - &RT_AU_Relay_00 { name : 'RT-00—[AU-Relay]—(澳洲中转节点信息)'   
    - &RT_AU_Relay_01 { name : 'RT-01—[AU-Relay]—(澳洲中转节点信息)'   
   ...
   ### ----------------------------------------------------------------
    ...
    - &RT_TW_Relay_00 { name : 'RT-00—[TW-Relay]—(台湾中转节点信息)'   
    - &RT_TW_Relay_01 { name : 'RT-01—[TW-Relay]—(台湾中转节点信息)'   
   ...
   ### ----------------------------------------------------------------
    ...
    - &RT_SG_Relay_00 { name : 'RT-00—[SG-Relay]—(新加坡中转节点信息)' 
    - &RT_SG_Relay_01 { name : 'RT-01—[SG-Relay]—(新加坡中转节点信息)' 
...
#  ### ----------------------------------------------------------------
#
#   - &RT_NL_Relay_00 { name : 'RT-00—[NL-Relay]—(荷兰中转节点信息)'   
#   - &RT_NL_Relay_01 { name : 'RT-01—[NL-Relay]—(荷兰中转节点信息)'   
#
#  ### ----------------------------------------------------------------
#  ### 德国（DE） -                                                    
#  ### ----------------------------------------------------------------
#
#   - &RT_DE_Relay_00 { name : 'RT-00—[DE-Relay]—(德国中转节点信息)'   
#   - &RT_DE_Relay_01 { name : 'RT-01—[DE-Relay]—(德国中转节点信息)'   
...
<br> 
  ...
  - ### 🟩 第三步，根据自己的节点位置 整理命名
    ...
    > 如果你下载的是 “纯ClashMeta模版” 即 [Desktop] / [Mobile] / BlackList 模版 ，到这一步就结束了 。
