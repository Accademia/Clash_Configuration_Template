...
本模版，默认是 白名单模式。如果魔改本模版，切换到只支持黑名单模式？
那只需要在配置模版中，检索 “ BlackList ” 关键词，注释掉“ BlackList ” 关键词包裹住的段落，你就会得到一个 黑名单模版。

- 但，依旧强烈推荐 白名单模式：因为，足够省心！毕竟黑名单最大的问题，就是可能会三天两头 补充规则，不胜其烦。
